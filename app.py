...
def check_password():
    """Verify user password from st.secrets."""
    if "authenticated" not in st.session_state:
        st.session_state.authenticated = False
    
    if not st.session_state.authenticated:
        st.title("🔒 Login to Your Portfolio")
        st.write("Enter your password to access your private portfolio tracker.")
...
# CHECK PASSWORD FIRST - THIS MUST RUN BEFORE ANY OTHER CODE
check_password()
...
# MAIN LAYOUT
# ==============================
st.title("📈 Portfolio Tracker - Private Dashboard")
st.write("👤 Welcome! Your portfolio is private and secure.")
